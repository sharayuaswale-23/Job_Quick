...
const HosterDetail = () => {
  ...
  const images = [
    "https://plus.unsplash.com/premium_photo-1677087122617-24594a576c85?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    "https://plus.unsplash.com/premium_photo-1681490054370-7b6402c18e6c?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mzl8fGxhcHRvcGdpcmx8ZW58MHx8MHx8fDA%3D",
    "https://plus.unsplash.com/premium_photo-1664372145494-460b16e46310?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NTN8fGxhcHRvcGdpcmx8ZW58MHx8MHx8fDA%3D",
  ];
...
//     <div className="flex min-h-screen p-14 rounded-lg bg-white w-full flex-col md:flex-row">
   
//     {/* Right Side - Content */}
//     <div className="flex-1 flex rounded-l-lg bg-gray-100 justify-center items-center p-4 w-full">

//     <div className="h-screen flex my-6 items-center justify-center">
...
//      <div className="hidden rounded-r-lg md:block w-1/2 bg-cover bg-center" style={{
