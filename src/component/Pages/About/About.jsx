...
const About = () => {
  ...
  return (
    ...
    <Header/>
{/* Part 1  */}
 <div className="min-h-screen bg-gray-50 flex flex-col justify-center items-center mt-20 px-6 md:px-12">
      {/* Hero Section */}
      ...
      {/* Call to Action */}
      <div className="mt-12">
        <button className="px-6 py-3 bg-green-500 text-white font-semibold text-lg rounded-full hover:bg-green-600 shadow-md transition-all">
          Get Started →
        </button>
      </div>
    </div>
...
<div className=" bg-gray-100 flex flex-col justify-center items-center py-10 mt-6">
      <div className="max-w-6xl w-full grid md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <button className="mt-8 px-6 py-3 bg-green-500 text-white font-semibold text-lg rounded-lg hover:bg-green-600 shadow-md transition-all">
            See More →
          </button>
        </div>
      </div>
    ...
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-50 to-white">
      <div className="max-w-6xl w-full grid md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <button className="mt-6 px-6 py-3 bg-green-600 text-white font-semibold text-lg rounded-lg hover:bg-green-700 transition-all shadow-md">
