export default function Career() {
  ...
  return (
    <div className="flex flex-col items-center justify-center p-10 bg-gray-100 min-h-screen">
      ...
      <div className="relative flex flex-col lg:flex-row items-center justify-center gap-12 md:gap-20">
        {steps.map((step, index) => (
          <div key={step.id} className="relative flex flex-col items-center text-center">
            ...
            <div className="absolute -bottom-7 bg-blue-500 text-white text-lg font-bold px-5 py-2 rounded-full shadow-lg">
              {step.id}
            </div>
            ...
            {index !== steps.length - 1 && (
              <div className="absolute top-16 left-[110%] w-24 md:w-28 h-2 bg-blue-300 lg:block hidden animate-pulse"></div>
            )}
          </div>
        ))}
      </div>
